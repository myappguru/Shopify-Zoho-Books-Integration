    ...
    <Form method="post" className="tax-form"><input type="hidden" name="intent" value="save-tax-settings" />
      ...
      <div className="tax-workspace">
        ...
        {tab === "mapping" ? <>
          ...
          <div className="tax-bottom-note"><Icon type="info" />Tax mappings will be used for all future syncs. You can update mappings at any time.</div>
