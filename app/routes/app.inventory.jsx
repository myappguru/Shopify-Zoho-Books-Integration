...
export const loader = async ({ request }) => {
  ...
  if (productsJson.errors?.length) {
    ...
    return {
      ...
      pagination: { page, totalPages, hasNextPage: false, hasPreviousPage: false, startCursor: null, endCursor: null },
      loadError: message,
    };
  }
