...
const PRODUCTS_LAST_QUERY = `#graphql
  query InventoryProductsLast($last: Int!) {
    products(last: $last) { edges { node { ...InventoryProductFields } } pageInfo { hasNextPage hasPreviousPage startCursor endCursor } }
  }
  ${PRODUCT_FIELDS}
`;
...
export const loader = async ({ request }) => {
  ...
  if (lastPage) productsResponse = await admin.graphql(PRODUCTS_LAST_QUERY, { variables: { last: PAGE_SIZE } });
